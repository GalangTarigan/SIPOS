                    ...
                    <div class="col-md-12">
                        <div class="panel panel-midnightblue">
                            ...
                            <div class="panel-body">
                                <form action="{{ Route('showGaransiKasirHasil') }}" method="POST" class="form-horizontal row-border"
...
@section('script')
    ...
    <script type="text/javascript" src="{{asset('demo/demo-cari-info-garansi-kasir.js')}}"></script>
@stop
