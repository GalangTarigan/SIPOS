    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Daftar-Barang-kasir</a></li>
            </ol>
            <div class="page-heading">
                <h1>Daftar Barang</h1>
                <div class="options">
                    <div class="btn-toolbar">
                        <a href="{{ route('formTambahBarangKasir') }}" class="btn btn-success">Tambah Barang Baru <i
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-daftar-barang-kasir.js') }}"></script>
@stop
