    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('dashboardKasir') }}">Dashboard-Kasir</a></li>
            </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a class="info-tile tile-sky has-footer" href="#">
                            <div class="tile-heading">
                                <div class="pull-left">Omset Hari Ini</div>
                                <div class="pull-right">
                    ...
                    <div class="col-md-3">
                        <a class="info-tile tile-success has-footer" href="#">
                            <div class="tile-heading">
                                <div class="pull-left">Omset Bulan Ini</div>
                                <div class="pull-right">
                    ...
                    <div class="col-md-3">
                        <a class="info-tile tile-magenta has-footer">
                            <div class="tile-heading">
                                <div class="pull-left">Omset Tahun Ini</div>
                                <div class="pull-right">
                                    <div id="tilerevenues" class="sparkline-block"></div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-dashboard-kasir.js') }}"></script>
@stop
