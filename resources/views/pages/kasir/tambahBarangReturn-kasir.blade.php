    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('showDaftarBarangReturn-kasir') }}">Daftar Barang</a></li>
                ...
                <div data-widget-group="group1">
                    <div class="panel panel-midnightblue">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{route('addBarangReturn-kasir')}}" method="POST" class="form-horizontal row-border" data-parsley-validate
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label labalaba" style="padding-top: 11px !important;">
                                       Nama Sales &nbsp;&nbsp;&nbsp;&nbsp; : </label>
                                    <div class="col-sm-7">
                                        <div class="wrap-input100" data-validate="Kolom tida boleh kosong">
                                            <input required class="input100" type="text" name="nama_sales" id="nama_sales" readonly>
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-tambah-barang-return-for-kasir.js') }}"></script>
    <!--Must Include -->
