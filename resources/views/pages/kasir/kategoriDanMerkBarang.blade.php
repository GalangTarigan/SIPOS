                            ...
                            <div class="panel-body">                                
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tambah-kategori">
                                            <form action="{{route('addKategoriKasir')}}" method="POST" class="form-horizontal row-border"
                            ...
                            <div class="panel-body">                                
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tambah-merk">
                                        <form action="{{route('addMerkBarangKasir')}}" method="POST" class="form-horizontal row-border"
                                            data-parsley-validate data-parsley-errors-messages-disabled id="validate-form"> {{ csrf_field() }}
                                            <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-top: 10px !important">
                <form action="{{route('updateKategoriKasir')}}" method="POST" class="form-horizontal row-border"
...
<div class="modal fade" id="editModalMerk" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-top: 10px !important">
                <form action="{{route('updateMerkBarangKasir')}}" method="POST" class="form-horizontal row-border"
                    data-parsley-validate data-parsley-errors-messages-disabled id="validate-form">
                    {{ csrf_field() }}
                    <div class="form-group">
...
<script type="text/javascript" src="{{asset('demo/demo-kategori-barang-kasir.js')}}"></script>
@stop
