    ...
    <div class="static-content">
        <div class="page-content"> 
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('garansiUser') }}">Cari Info Garansi</a></li>
            ...
            <div class="options">
                <div class="btn-toolbar">
                    <a href="{{ route('garansiUser') }}" class="btn btn-primary"><i class="fa fa-fw fa-search"></i>
                        &nbsp; Cari Transaksi Lain nya ? 	&nbsp;</a>
                </div>
            </div>
            </div>
...
@section('script')
    ...
    <script type="text/javascript" src="{{asset('demo/demo-lihat-info-garansi-user.js')}}"></script>
@stop
