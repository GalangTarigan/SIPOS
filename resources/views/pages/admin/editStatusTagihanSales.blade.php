    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Ubah Status Tagihan</a></li>
            </ol>
            <div class="page-heading">
                <h1>Bayar / Ubah Tagihan Sales</h1>
            </div>
                ...
                <div data-widget-group="group1">
                    <div class="panel panel-midnightblue">
                        <div class="panel-heading">
                            <h2>Form Bayar / Ubah Tagihan Sales {{ $data->nama_sales }}  </h2>
                        </div>
                        ...
                        {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="wrap-input100">
                                            ...
                                            value="{{ $data->no_faktur }}" name="tempo">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="wrap-input100">
                                            <input class="input100" readonly
                                            value="{{ $data->jumlah_tagihan }}" name="tempo">
                                            <span class="focus-input100"></span>
                                        </div>
                                    </div>
                                </div>
