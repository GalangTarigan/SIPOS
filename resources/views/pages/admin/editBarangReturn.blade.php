                ...
                <div data-widget-group="group1">
                    <div class="panel panel-midnightblue">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{ route('editBarangReturn') }}" method="POST" class="form-horizontal row-border" data-parsley-validate
...
@section('script')
    ...
    <script>
        ...
        var tanggal_pengambilan = {!! json_encode($data->tanggal_pengambilan) !!};
        var status = {!! json_encode($data->status) !!};
