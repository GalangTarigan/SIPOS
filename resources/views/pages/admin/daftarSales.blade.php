    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Daftar Sales</a></li>
            </ol>
            <div class="page-heading">
                <h1>Daftar Sales</h1>
                <div class="options">
                    <div class="btn-toolbar">
                    <a href="{{ route('formTambahTagihan') }}" class="btn btn-primary">Tambahkan Tagihan Sales <i
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-daftar-sales.js') }}"></script>
@stop
