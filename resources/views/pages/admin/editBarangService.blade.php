                ...
                <div data-widget-group="group1">
                    <div class="panel panel-midnightblue">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{route('editService')}}" method="POST" class="form-horizontal row-border"
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-edit-barang-service.js') }}"></script>
    <!--Must Include -->
