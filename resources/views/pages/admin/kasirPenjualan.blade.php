                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2" style="float:left;">
                                            ...
                                            <div class="wrap-input100 input-group" data-validate="Tidak Boleh Kosong">
                                        ...
                                        <div class="col-sm-3" style="float:left; ">
                                            <div class="wrap-input100" data-validate="Tidak Boleh Kosong">
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-kasir.js') }}"></script>
@stop
