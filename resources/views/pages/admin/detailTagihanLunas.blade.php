    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Detail Tagihan Lunas</a></li>
            </ol>
            <div class="page-heading">
                <h1>Tagihan Lunas - Sales {{ $data->nama_sales }}</h1>
            </div>
                    ...
                    <div class="panel panel-midnightblue">
                        ...
                        <div action="#" method="POST" class="panel-body" style="margin-top: 10px !important">
                            <form class="form-horizontal row-border" class="form-horizontal row-border"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7" id="imgPrevContainer">
                                        ...
                                        <div class="images_prev_lang">                                            
                                            @if (!$dokumentasi_tagihan->isEmpty())
                                                <script>
                                                    var counter = {!!json_encode($dokumentasi_tagihan) !!};

                                                    counter = counter.length
                                                </script>
                                                @foreach ($dokumentasi_tagihan as $foto)
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" style="padding-top: 16px !important;">Tanggal Dibayar
                                        &nbsp;&nbsp;&nbsp;&nbsp;:</label>
                                    <div class="col-sm-7">
                                        <div class="wrap-input100">
                                            <input required class="input100" readonly
                                                value="{{ $data_tgl_dibayar }}">
                                            <span class="focus-input100"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" style="padding-top: 16px !important;">Metode Bayar
                                        &nbsp;&nbsp;&nbsp;&nbsp;:</label>
                                    <div class="col-sm-7">
                                        <div class="wrap-input100">
                                            <input required class="input100" readonly
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" style="padding-top: 11px !important;">
                                        ...
                                        @if (!$dokumentasi_transfer->isEmpty())
                                        <div class="col-sm-7" id="imgPrevContainer">                                    
                                            <div class="images_prev_lang">                                            
                                                <script>
                                                    var counter = {!!json_encode($dokumentasi_transfer) !!};

                                                    counter = counter.length
                                                </script>
                                                @foreach ($dokumentasi_transfer as $foto)
                                                    <div class="img" onclick="imagesNewTabLunas('{{$foto->nama_file_transfer}}')"
                                                        style="background-image:url({{ asset('/dokumentasi/bukti_transfer/get-foto/' . $foto->nama_file_transfer) }})"
                                                        >
                                                        <span></span>
                                                    </div>            
                                                    @endforeach
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="wrap-input100">
                                                        <input required class="input100" readonly
                                                            value="Tidak ditemukan karena dibayar langsung">
                                                        <span class="focus-input100"></span>
                                                    </div>
                                                </div>
                                            @endif
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-detail-tagihan-lunas.js') }}"></script>
    <!--Must Include -->
