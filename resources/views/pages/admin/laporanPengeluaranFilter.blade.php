    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li>Keuangan</li>
                <li class="active"><a href="">Cari Laporan Pengeluaran</a></li>
            </ol>
            <div class="page-heading">
                <h1>Cari Laporan Pengeluaran</h1>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-midnightblue">
                            <div class="panel-heading">
                                <h2> Form Filter Laporan Pengeluaran</h2>
                                <div class="panel-ctrls">
                                </div>
                            </div>
                            <div class="panel-body">
                                <form action="{{route('LaporanPengeluaranHasil')}}" method="POST" class="form-horizontal row-border"
