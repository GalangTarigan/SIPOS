    ...
    <div class="static-content">
        <div class="page-content">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Edit Sales</a></li>
            </ol>
            ...
            <div class="container-fluid">
                ...
                <div data-widget-group="group1">
                    <div class="panel panel-midnightblue">
                        ...
                        <form class="form-horizontal row-border" action="{{route('editSales', $data_sales->id_sales )}}" method="POST"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="wrap-input100" data-validate="Kolom tidak boleh kosong">
                                            <input required class="input100 @error('nama_lengkap') is-invalid @enderror"
                                                ...
                                                value="{{ $data_sales->nama_perusahaan }}">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="wrap-input100" data-validate="Inputan tidak valid">
                                            <input required type="number" minlength="10" maxlength="15"
                                                ...
                                                name="no_telepon" autocomplete="off" value="{{$data_sales->no_telepon }}" onKeyPress="if(this.value.length==12) return false;">
                                            <span class="focus-input100"></span>
                                        </div>
                                        @error('no_telepon')
                                            <span class="text-danger">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="wrap-input100" data-validate="Kolom tidak boleh kosong">
                                            <input required class="input100 @error('nama_lengkap') is-invalid @enderror"
                                                ...
                                                value="{{ $data_sales->nama_no_rekening }}">
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('demo/demo-edit-sales.js') }}"></script>
    <!--Must Include -->
