...
$(function(){
    ...
    var table
    $.ajax({
		url: "/kasir/barang-service-kasir/list-barang-service",
		type: 'post',
		data: {
            "_token" : token,              
		},
    ...
    $('#table').on('click', 'tbody tr', function () {
        ...
        window.location.href = '/kasir/barang-service-kasir/detail-barang-service?data=' + id;
    });

    
    // di klik untuk detail barang
    ...
    $('#table tbody').on( 'click', '#edit', function (e) {
        ...
        let id = table.row( $(this).parents('tbody tr') ).data().id_service;
        // alert('ini id' + id)
        window.location.href = '/kasir/barang-service-kasir/edit-barang-service?data=' + id;
    });
    ...
    $('#table tbody').on( 'click', '#delete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post({
                    url: '/kasir/barang-service-kasir/delete-barang-service?data=' + id,
                    // type: 'POST',
                    method: 'POST',
                    data: {
                        _token: token,
                    ...
                    success: function (data) {
                        ...
                        if (data['status']) {
                            ...
                            window.location.href ='/kasir/barang-service-kasir/daftar-barang-service-success';
                        } else {
                            Swal.fire(
                                {
                                    type: 'error',
