...
$(function(){
    ...
    var table
    $.ajax({
		url: "/kasir/barang_return-kasir/list-barang-return",
		type: 'post',
		data: {
            "_token" : token,              
		},
    ...
    $('#table tbody').on( 'click', '#editBarang', function (e) {
        ...
        // console.log(uuid)        
        window.location.href = '/kasir/barang-return-kasir/formEditBarangReturn?barangReturn=' + id_barang_return;
    });
    ...
    $('#table tbody').on( 'click', '#delete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post({
                    url: '/kasir/barang_return-kasir/delete_barang_return?barang_return=' + id_barang_return,
                    // type: 'POST',
                    method: 'POST',
                    data: {
                        _token: token,
                    ...
                    success: function (data) {
                        ...
                        if (data['status']) {
                            ...
                            window.location.href ='/kasir/barang-return-kasir/delete-barang-return-success';
                        } else {
                            Swal.fire(
                                {
                                    type: 'error',
