...
$(function(){
    ...
    var table
    $.ajax({
		url: "/admin/manajemen-barang/list-barang",
		type: 'post',
		data: {
            "_token" : token,              
		},
    ...
    $('#table tbody').on( 'click', '#editBarang', function (e) {
        ...
        console.log(id_barang)
        // console.log(uuid)        
        window.location.href = '/admin/manajemen-barang/formEditBarang?barang=' + id_barang;
    });
    ...
    $('#table tbody').on( 'click', '#delete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post({
                    url: '/admin/manajemen-barang/delete_barang/' + id_barang,
                    // type: 'POST',
                    method: 'POST',
                    data: {
                        _token: token,
                    ...
                    success: function (data) {
                        ...
                        if (data['status']) {
                            ...
                            window.location.href ='/admin/manajemen-barang/delete-barang-success';
                        } else {
                            Swal.fire(
                                {
                                    type: 'error',
