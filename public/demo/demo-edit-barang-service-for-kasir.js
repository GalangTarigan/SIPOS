...
// ketika kita menekan tombol ubah status
function showStatusBaru(){
    ...
    // select.value = ''; // untuk buat null value ketika kita pilih batal edit
    ...
    if( x == "Belum Selesai"){
        ...
        select.selectedIndex = -1;
        $('div#s2id_select2_status_barang .select2-chosen').text('Pilih Status Service')
        // $("#select2_status_barang").append('<option value="Selesai" > Selesai </option>')
    } 
}
