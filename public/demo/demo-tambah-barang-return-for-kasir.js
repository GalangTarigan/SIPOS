...
$( document ).ready(function() {
    ...
    $.ajax({
        url: '/kasir/barang-return-kasir/getKategori/',
        type: 'post',
        data: {
            _token: token
        },
    ...
    $("#select2_kategori_barang").on('change', function () {
        ...
        if (id_kategori == "") {
            ...
            $.ajax({
                url: '/kasir/barang-return-kasir/getDaftarMerk',
                type: 'post',
                data: {
                    _token: token,
    ...
    $("#select2_merk_barang").on('change', function () {
        ...
        if (id_merk == "") {
            ...
            $.ajax({
                url: '/kasir/barang-return-kasir/getTipeBarang',
                type: 'post',
                data: {
                    _token: token,
                    merk: id_merk
    ...
    $("#select2_tipe_barang").on('change', function () {
        ...
        $.ajax({
            url: '/kasir/barang-return-kasir/getMaxBarang',
            type: 'post',
            data: {
                _token: token,
                id_barang: id_barang
