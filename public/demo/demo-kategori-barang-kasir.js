...
$(function(){
    ...
    var table
    $.ajax({
		url: "/kasir/manajemen-barang-kasir/daftar-kategori-barang",
		type: 'post',
		data: {
            "_token" : token,              
		},
    ...
    $('#table').on( 'click', '#delete', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post({
                    url: '/kasir/manajemen-barang-kasir/delete/' + id_kategori,
                    // type: 'POST',
                    method: 'POST',
                    data: {
                        _token: token,
                    ...
                    success: function (data) {
                        ...
                        if (data['status']) {
                            ...
                            window.location.href ='/kasir/manajemen-barang-kasir/delete-kategori-barang-success';
                        } else {
                            Swal.fire(
                                {
                                    type: 'error',
...
$(function(){
    ...
    var table
    $.ajax({
		url: "/kasir/manajemen-barang-kasir/data-merk-barang",
		type: 'post',
		data: {
            "_token" : token,              
		},
    ...
    $('#table-merk').on( 'click', '#edit_merk', function () {
     ...
     $('#table-merk').on( 'click', '#delete_merk', function () {
        ...
        json = table.row( $(this).parents('tbody tr') ).data();
        Swal.fire({
            title: 'Anda yakin menghapus ' + merk + ' ?',
            text: "Anda tidak akan bisa merubah jika setuju!!",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            ...
            if (result.value) {
                $.post({
                    url: '/kasir/manajemen-barang-kasir/delete-merk/' + id_merk,
                    // type: 'POST',
                    method: 'POST',
                    data: {
                        _token: token,
